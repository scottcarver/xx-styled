<?php
// Also load the sidebar
// require_once('sidebar-as-component/plugin-sidebar.php');
/*
register_meta('post', 'my_post_meta_key', array(
    'show_in_rest' => true,
    'single' => true,
    'type' => 'boolean',
));

register_meta('post', 'my_post_meta_string', array(
    'show_in_rest' => true,
    'single' => true,
    'type' => 'string',
));

register_meta('post', 'my_post_meta_obj', array(
    'show_in_rest' => true,
    'single' => true,
    'type' => 'string',
));
